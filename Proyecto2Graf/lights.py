from mathlib import menosvector, dot, multVectorScalar, normVector, reflectVector, RestaVector, vectorMagnitude
...
class DirectionalLight(Light):
    ...
    def getDifusseColor(self, intercept):
        ...
        dir = menosvector(self.direction)
    ...
    def getSpecularColor(self, intercept, viewPos):
        ...
        viewDir = RestaVector(viewPos, intercept.point)
...
class PointLight(Light):
    ...
    def getDifusseColor(self, intercept):
        dir = RestaVector(self.point, intercept.point)
